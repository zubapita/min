...
class MakeNewAppLib extends MakeDbClassFileLib
{
    ...
    public function main()
    {
        ...
        if (!file_exists($newAppRoot)) {
            ...
            $subdirs = array(
                ...
                "view/cmn/js"=>0755,
                "view/cmn/js/jarty"=>0755,
                "view/cmn/js/validationEngine"=>0755,
                "view/cmn/js/validationEngine/languages"=>0755,
                "view/cmn/js/validationEngine/contrib"=>0755,
                "view/cmn/lang"=>0755,
    ...
    public function copySubdirs($thisDir, $newAppRoot)
    {
        $_ = $this;
