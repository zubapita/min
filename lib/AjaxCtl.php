...
class AjaxCtl extends AppCtl
{
     ...
     * @return array
     **/
    public function getPostedData($raw=false)
    {
        $postedData = array();
     ...
     * @return boolean 成功した場合はtrue
     **/
    public function sendHtml($html, $debug_data='-')
    {
     ...
     * @return boolean 成功した場合はtrue
     **/
    public function sendData($data, $debug_data='-')
    {
        $response = new StdClass;
        $response->status = true;
        $response->data = $data;
     ...
     * @return boolean 成功した場合はtrue
     **/
    public function sendNotice($message, $debug_data='-')
    {
        $response = new StdClass;
        $response->status = true;
     ...
     * @return boolean 成功した場合はtrue
     **/
    public function sendError($message, $debug_data='-')
    {
        $response = new StdClass;
